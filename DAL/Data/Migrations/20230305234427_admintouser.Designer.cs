...
namespace WebApplication5.Data.Migrations
{
    ...
    [Migration("20230305234427_admintouser")]
    partial class admintouser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Entities.Appointment", b =>
                {
                    b.HasOne("DAL.Entities.Doctor", "Doctor")
                        .WithOne("Appointment")
                        .HasForeignKey("DAL.Entities.Appointment", "DoctorId");

                    b.HasOne("DAL.Entities.Patient", "Patient")
                        .WithOne("Appointment")
                        .HasForeignKey("DAL.Entities.Appointment", "PatientId")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DAL.Entities.Doctor", null)
                        .WithMany()
